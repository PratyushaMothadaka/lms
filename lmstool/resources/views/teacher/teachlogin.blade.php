    ...
    <body class="font-serif bg-gray-100">
        <div id="app" class="overflow-hidden">
            ...
            @endif
                ...
                <div class="bg-white container mx-auto shadow-lg" style="height: 360px ; width:420px">
                    <el-form class="flex flex-col py-10 px-6" action="/login/instructor" method="post">
                        @csrf
                        ...
                        <el-form-item class="mb-5">
                            <p class="text-center">or <el-link href="{{ url('/teaching/forgotpassword') }}" class="text-teal-600 hover:text-teal-700 outline-none">Forgot Password</el-link></p>
                        </el-form-item>
                        <el-form-item class="mb-5">
                            <p class="text-center">Don't have an Account?
                            <el-link href="{{ url('/join/instructor') }}" class="font-bold text-teal-600 hover:text-teal-700 outline-none">Sign Up Now</el-link>
                            </p>
                        </el-form-item>
                    </el-form>
                </div>
